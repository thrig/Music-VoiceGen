...
# subsets!
{
  ...
  $svg->subsets(
    3, 4,
    sub { push @subsets, \@_ },
    # not-reference form also supported, in the hypothetical case
    # someone forgets to pass an array ref
    qw/65 67 69 60 62/,
  );
  $deeply->(
    \@subsets,
    [ [qw/65 67 69/], [qw/65 67 69 60/],, [qw/67 69 60/],
      [qw/67 69 60 62/], [qw/69 60 62/],
    ],
    "expected subsets"
  );
}
